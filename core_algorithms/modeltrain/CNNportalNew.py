...
class NetShortCircuit(nn.Module):
    def __init__(self):
        ...
        self.cov2 = nn.Conv1d(in_channels=32, out_channels=64, kernel_size=2, stride=1)
...
optimizer1 = torch.optim.Adam(net.parameters(), lr = lr * 0.5)
optimizer2 = torch.optim.Adam(net.parameters(), lr = lr * 0.3)
optimizer3 = torch.optim.Adam(net.parameters(), lr = lr * 0.1)
