...
if __name__ == '__main__':
    load_model_path = '../model/DNN_2023-03-13-10-56-53.pth'
    mean_pca = np.loadtxt('../pca result/mean_pca.txt', comments='%')
    vector_pca = np.loadtxt('../pca result/vector_pca.txt', comments='%')
    test_input = np.array([-9.832595976954838779e-01, -9.885149800291961331e-01, 9.504103933898914169e-01, 9.885149800292000188e-01]).reshape(1, -1)
