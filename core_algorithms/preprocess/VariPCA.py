...
data = np.loadtxt('../data/trainPCA.txt', comments='%', encoding='utf-8')
# print(data.shape)   # (96, 60)

# 选第一个周期后的连续3个周期
time_data = np.linspace(0.02, 0.0595, 120)
...
first_data1 = np.abs(first_data)
print(max(first_data1))
print(min(first_data1))
...
plt.scatter(time_data, mean_data, s=1)
# plt.legend()
