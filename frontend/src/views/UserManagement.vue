    ...
    <div class="flex justify-between items-start">
      <div class="flex items-center gap-4">
        <div class="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
             style="background:linear-gradient(135deg,#4f46e5,#818cf8); box-shadow:0 0 20px rgba(99,102,241,0.4);">
          <el-icon size="22" style="color:white;"><User /></el-icon>
        </div>
        <div>
          ...
          <h1 class="text-lg font-bold text-white tracking-tight">用户管理</h1>
          <p class="text-slate-400 text-sm mt-0.5">管理系统用户账号与权限分配</p>
        </div>
      </div>
